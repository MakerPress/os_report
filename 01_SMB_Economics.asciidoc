...
=== Economic Impact Enabled by Lower Costs ** I would change this header name, eg, The Economics of Open Source | Open Source Economic Impact Model
...
Keep in mind that beyond creating their own web presence, SMBs and HBBs have access to number of commerce platforms that are built on open source architectures, including: eBay, Amazon, Etsy, and Google. Even those SMBs with who build their own web presence may include storefronts on eBay, Amazon or Etsy, and may augment their marketing via Facebook and Twitter - both also built on open source architectures. >>

...
=== Economic Impact Enabled by Lower Costs

//rm note 2012-07-5: I would change this header name, eg, The Economics of Open Source | Open Source Economic Impact Model end rm note)

...
// rm note 2012-07-05: mention as a sidebar?:
For tech savvy SMBs, open source offers other benefits in addition to low cost: access to the source code, including the ability to make changes specific to your business, and access to community-based support. There are many stories of those using open source tools finding a problem, posting the problem on an online forum and having the person who wrote the code respond with a fix end rm note
// end rm

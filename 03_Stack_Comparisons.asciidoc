...
The growth of open source tools during the past several years is not an easy measure to obtain. The following analysis will be a combination of job data along with user data from Bluehost. 
...
By any measure we can find, WordPress is the clear leader in CMSs applications. 

...
[options="header"]
|=======
|e-Commerce|Javascript|Perl|Php|Python|Ruby
|Magento|99%|53%|100%|22%|19%
|Oscomm|74%|42%|86%|9%|8%
|Presta|100%|55%|100%|22%|21%
|=======

The next table shows the median, not the average. This way we won't see the data skewed by some large variants. Think of this as the typical users that have Magento use Javascript 96% of the time.

[options="header"]
|=======
|e-Commerce|JS Median|PE Median|PH Median|PY median|R median
|Magento|96%|33%|98%|12%|12%
|Oscomm|27%|21%|40%|5%|4%
|Presta|100%|34%|100%|10%|13%
|=======

[options="header"]
|=======
|e-Commerce|JS big|PE big|PH big|PY big|R big
|Magento|42%|14%|97%|2%|1%
|Oscomm|12%|9%|17%|1%|0%
|Presta|67%|15%|68%|2%|1%
|=======

...
Equally interesting is how many iPhone OS users there are and in the Browser chart above you'll notice that Mobile Safari had the 3rd largest browser share. So while BlueHost's customers use Linux and other open source software for their web hosting needs, they use  consumer oriented devices and platforms to interact with the Web. 

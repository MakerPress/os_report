...
// got this from Jean.  she is getting the exact position they occupy.  i think it is 6th but we will see what she comes up with tomorrow.

We are working with a unique data set provided by Bluehost and several other hosting providers associated with Endurance International Group, a web hosting company that provides hosting services to 2,004,297 million sites worldwide which in our estimation makes BlueHost the 6th largest hosting firm. For our analysis, they provided us with more than one million anonymized customer records, plus the results of a survey of approximately four thousand customers.

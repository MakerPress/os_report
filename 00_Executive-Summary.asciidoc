...
To get a little more perspective on the data and trends in the data, the following four charts show growth in Retail *Technical* Book Sales in North America as reported by Nielsen Bookscan, and Bluehost new users created with a North American filter applied, and Job postings for the US and Technical Job postings for the US. To get a consistent view, the data shows 2009-01 through 2012-05 for all four charts.

As you can see by the trend lines for three of the four charts, there is a positive growth, yet the Technical book Market shows a consistent decline.  Although these two measures are not correlated, they do provide some perspective on *technology adoption and demand*. We compared 2009 and on because our Job data is not as reliable the further we go back.  Much of the data in the remaining report will be for 2001 and on because Bluehost has reliable data going that far back.

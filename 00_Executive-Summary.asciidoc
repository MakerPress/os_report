...
Let's first take a look at which countries are growing the quickest in hosted services.  You could view this as a proxy for small economies growing rapidly.

...
Below are five charts that will help set some perspective.  The first chart shows NASDAQ's closing for each week from 2009-01 through 2012-05 which is our study range for these five charts. To get a little more perspective on the data and trends in the data, the remaining four charts show growth all jobs that are posted for any particular job.  This job data set contains terabytes of text for the US only.  The next chart shows a filter on this job data to select only the categories that are also found in the Bluehost data (php, perl, javascript, drupal, word press, etc.) so we can compare similar growth trends.  The third chart contains Tech Book Retail sales to see if there is any similar seasonal effect and lastly we have user growth rates for Bluehost data.  This shows how many new users are added to Bluehost accounts.  Since only BlueHost data is global, I filtered for these four charts to be US only and between 2009-present.

As you can see by the trend lines for four of the five charts, the trendline is moving upward which indicates growth, yet the Technical book Market shows a consistent decline.  Although these measures are not correlated, they do provide some perspective on *technology adoption and demand*. Again, we compared 2009 to the present because our Job data is not as reliable the further we go back.  Much of the data in the remaining report will be for 2001 to present because Bluehost has reliable data for that period.

image::images/nasdaq_03-12.jpg[scaledwidth="90%",align="left"]

image::images/google_trends.jpg[scaledwidth="90%",align="right"]

image::images/job_all_03-12.jpg[scaledwidth="90%",align="left"]  

image::images/job_tech_03-12.jpg[scaledwidth="90%",align="right"]

image::images/books_03-12.jpg[scaledwidth="90%",align="left"]

image::images/bluehost_users_03-12.jpg[scaledwidth="90%",align="right"]

...
The typical open source website used the methods of payment shown above.  Nearly 53% use PayPal to generate revenue, 12% Check or Money order via mail, CC Online = Credit Card online, CC Phone = Credit card usage via the phone.

...
While the users were filling out their survey, the Browser dimension was captured automatically. The following chart is a bit surprising in that it is heavily dominated by FireFox. The dominate combination of and OS and Browser was Windows running Firefox.

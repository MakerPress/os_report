...
Contrast the image above with the one immediately below.  The one below is based on the number of individuals electing to use the tools that are offered to them with a Bluehost account.
